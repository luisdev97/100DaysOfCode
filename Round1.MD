...
#### Day 34 February 26. Wednesday

**Today's Progress:** Today among other things I created a basic version of the node server that I will use to run my script

**Link to repo:** [Node Server to extract info from HTML nodes](https://github.com/luisdev97/Extract-DOMnodes-Info)


#### Day 35 February 27. Thursday

**Today's Progress:** Today I modified my script and almost finished it, I need to apply recursion to solve a small problem and soon I can continue with the pokedex


#### Day 36 February 28. Friday

**Today's Progress:** Today I didn't have much time to program so I spent some time doing TypeScript exercises in exercism.io


#### Day 37 February 29. Saturday

**Today's Progress:** Today I was reviewing the basics of Angular since I started my training in practices within a week and we will use angular in the front


#### Day 38 March 1. Sunday

**Today's Progress:** Today I could almost finish my server to collect the data that I will later use in my pokedex, I just need to solve a problem with asynchrony when saving the data in a json file


#### Day 39 March 2. Monday

**Today's Progress:** Today I managed to finish the first version of my script to scrape data from the web and store data in a json, It is still slow but it is functional.

**Thoughts:** Now that I'm done I can continue with the pokedex, although I hope someone improves my code and learn from its optimization


#### Day 40 March 3. Tuesday

**Today's Progress:** Today I arrived very late home and spent some time practicing a little TypeScript in exercism.io and read a bit about functional programming


#### Day 41 March 4. Wednesday

**Today's Progress:** Today I refactored my code to be able of incorporating a new service to work with IBM Clod API, wich can read text from a JSON file

**Thoughts:** I've not reached a good way to incorporate it properly yet


#### Day 42 March 5. Thursday

**Today's Progress:** Today I have had virtually no time so I have done very basic algorithm exercises and I have seen a lecture on Angular and reactivity

**Link to talk:** [Data Composition with RxJS | Deborah Kurata](https://www.youtube.com/watch?v=Z76QlSpYcck)


#### Day 43 March 6. Friday

**Today's Progress:** Today I received the news that instead of working with React instead of Angular in the workplace training, I have been reviewing concepts that I have not used for a long time to be more prepared



#### Day 44 March 7. Saturday


**Today's Progress:** Today was a hard day, I have encountered many problems with audio streaming that I could not solve, Another day things will be better



#### Day 46 March 9. Monday


**Today's Progress:** Today I started my workplace training and since yesterday I have been reviewing concepts related to their work in order to be more prepared, tomorrow to fulfill my first assigned task
